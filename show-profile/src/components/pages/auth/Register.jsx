...
export const Register = () => {
  const { input, setInput, functions, error, setError, statusOK } =
    useContext(Context);
  const { functionRegister } = functions;
  ...
  const HandleRegis = (event) => {
    ...
    if (!input.password_confirmation) {
      return setError({
        password_confirmation: "Cannot be empty",
      });
    }
        ...
        <div className="container px-6 py-12 h-full">
          <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
            ...
            <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
              <form method="post" onSubmit={HandleRegis}>
                <div className="mb-6">
                  <input
                    type="text"
                ...
                <div className="mb-6">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <p className="text-rose-600 italic"> {error.password}</p>
                </div>
                <div className="mb-6">
                  <input
                    type="password"
